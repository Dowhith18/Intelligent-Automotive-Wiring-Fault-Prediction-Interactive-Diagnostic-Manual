...
export const Car: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14 16.5V15a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v1.5m14-5.5-1.13-2.26a1 1 0 0 0-.9-.64H6.03a1 1 0 0 0-.9.64L4 11m16 0h-2M4 11H2m18 0a2 2 0 0 1-2 2h-1.35a1 1 0 0 1-1-.78L14.3 8.8a1 1 0 0 0-1.6 0l-1.35 3.42a1 1 0 0 1-1 .78H8a2 2 0 0 1-2-2m2 8.5h.01M18 19.5h.01"/>
  </svg>
);
...
export const LayoutDashboard: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <rect x="3" y="15" width="7" height="5"></rect>
        <rect x="14" y="11" width="7" height="9"></rect>
    </svg>
);
